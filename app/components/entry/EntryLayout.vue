...
import BlockContent from '~/components/entry/BlockContent.vue';
import TableOfContents from '~/components/entry/TableOfContents.vue';
import PropertyPanel from '~/components/entry/PropertyPanel.vue';
import Breadcrumb from '~/components/entry/Breadcrumb.vue';
import NewEntryModal from '~/components/entry/modals/NewEntryModal.vue';
import MoveEntryModal from '~/components/entry/modals/MoveEntryModal.vue';
import ConvertEntryModal from '~/components/entry/modals/ConvertEntryModal.vue';
import EditCategoriesModal from '~/components/entry/modals/EditCategoriesModal.vue';
import BrowseEntriesModal from '~/components/entry/modals/BrowseEntriesModal.vue';
import PlaceBlockModal from '~/components/entry/modals/PlaceBlockModal.vue';
