...
const baseButtonClasses = computed(() => [
  ...
  props.isActive || props.isPartiallyActive
      ...
      : "text-rimelight-neutral-50",
  "hover:border-rimelight-primary-400 hover:text-rimelight-primary-400 hover:no-underline",
]);
...
<template>
  ...
  >
    ...
    <template v-if="props.hasDropdown">
      ...
      >
        <ul role="menu" class="m-0 flex list-none flex-col gap-sm p-0">
          <slot />
        </ul>
      </div>
