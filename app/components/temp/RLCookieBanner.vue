...
<template>
  <UContainer>
    <RLLayoutBox
      ...
      class="bottom-4 -translate-x-1/2 left-1/2 z-50 bg-primary-900 border-1 border-primary-500"
    >
      <RLLayoutBox
      ...
      <span class="text-sm text-center">
        ...
        <RLLayoutBox
          ...
          gap="md"
        >
          <UButton variant="solid" color="primary" @click="hideBanner">Accept All</UButton>
          <UButton variant="solid" color="error" @click="hideBanner">Reject All</UButton>
        </RLLayoutBox>
      </RLLayoutBox>
    </RLLayoutBox>
  </UContainer>
