...
import SectionBlock from '~/components/basic/entry/blocks/structure/SectionBlock.vue';
import ParagraphBlock from '~/components/basic/entry/blocks/text/ParagraphBlock.vue';
import CalloutBlock from '~/components/basic/entry/blocks/text/CalloutBlock.vue';
import ImageBlock from '~/components/basic/entry/blocks/media/ImageBlock.vue';
import ScriptBlock from '~/components/basic/entry/blocks/screenwriting/ScriptBlock.vue';
import SceneBlock from '~/components/basic/entry/blocks/screenwriting/SceneBlock.vue';
import DialogueBlock from '~/components/basic/entry/blocks/screenwriting/DialogueBlock.vue';
